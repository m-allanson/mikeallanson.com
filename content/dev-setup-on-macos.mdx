...
- Install [1Password](1password.com)
- Install [Sublime Text](sublimetext.com)
- Install [Sublime Merge](sublimemerge.com) (seeing as we're downloading ST anyway) 
